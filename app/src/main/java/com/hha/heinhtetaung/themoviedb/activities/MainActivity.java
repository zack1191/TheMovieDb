...
public class MainActivity extends AppCompatActivity implements MovieDelegate, UpComingDelegate {
    ...
    @Override
    public void onTapMovieItems(MovieDBVo tapMovie) {
    ...
    @Override
    public void onTapUpcomingItems(MovieDBVo tapUpcoming) {
        Toast.makeText(this, tapUpcoming.getTitle(), Toast.LENGTH_SHORT).show();
        Intent intent = UpcomingActivity.newIntent(getApplicationContext(), tapUpcoming.getId());
        startActivity(intent);
    }
